...
from .views import ConversationList, ConversationDetail, PaticipantsList, ParicipantsDetail,MesssageDetail, GetMemberConversation, GetMessagesConversation, ConversationListFind
urlpatterns = [
