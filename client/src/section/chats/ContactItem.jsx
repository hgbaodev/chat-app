...
export const ContactItem = () => {
  return (
    <Flex className="bg-gray-100 p-2 rounded-md cursor-pointer" align="center" justify="space-between">
      <Space>
        ...
        <Flex vertical justify="center">
          ...
          <Typography className="overflow-hidden whitespace-nowrap text-ellipsis max-w-[120px]">
